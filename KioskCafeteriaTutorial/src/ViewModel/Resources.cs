...
namespace KioskCafeteriaTutorial
{
    static public class Resources
    {
        public static (string name, string res, string price)[] hotDrinkPool = {
            ("Pro Burger", "pro_burger1.png", "1.50"),
        ...
        public static ObservableCollection<MenuItemGroup> CreateData(this ObservableCollection<MenuItemGroup> result, int menuType)
        {
        ...
        static public List<int> SelectIndexArray = new List<int>();
